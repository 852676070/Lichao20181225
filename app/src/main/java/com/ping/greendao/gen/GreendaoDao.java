...
/** 
 * DAO for table "GREENDAO".
*/
public class GreendaoDao extends AbstractDao<Greendao, Long> {

    public static final String TABLENAME = "GREENDAO";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GREENDAO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GREENDAO\"";
        db.execSQL(sql);
    }
